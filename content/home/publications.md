...
### Publications
- Dieing, M., Volpi, M., **Boussange, V.**, _Biodiversity Profile Estimation with Earth Observation_. Accepted at the [IAPR Workshop on Pattern Recognition in Remote Sensing PRRS](https://iapr-tc7.github.io/prrs2026/) (2026).
...
### Preprints
- Plekhanova, E., Brun, P., Fischer, J.-C., Ma, H., **Boussange, V.**, Zimmermann, N.E., _Clustering biomes from space: from pixels to foundation models_. [[SSRN]](https://doi.org/10.2139/ssrn.6876998) (2026).

- Van Moorter, B., Kivimaki, I., Panzacchi, M., Schouten, R., Wuyts, B., Niebuhr, B. B., Saerens, M., **Boussange, V.**, _A Unified Framework for Prioritizing Habitat and Connectivity Conservation through Analytical Sensitivity_. [[bioRxiv]](https://doi.org/10.64898/2026.01.05.697654) (2026). Revision requested from Landscape Ecology.
...
### Talks
- _A gentle introduction to differentiable programming with applications in ecological modeling_, invited speaker, AMAP seminar, Montpellier, France (November 2025).
- _Deep learning based-species area relationships_, invited speaker, DeepSDM conference, Montpellier, France (May 2025).
- _Differentiable programming for ecology_, invited speaker, Inria Montbonnot, France (February 2025).
- _A deep species area model to map species richness and its sensitivity to habitat size_, poster, AI+Environment Summit, Zürich, Switzerland (October 2024).
- _Practical introduction to Julia for biodiversity research_, 3-day workshop organizer and speaker, German Centre for Integrative Biodiversity Research (iDiv), Leipzig, Germany (August 2024).
...
- _Numerical approximations of solutions of highly dimensional, non-local nonlinear PDEs_, invited speaker, StAMBio seminar, St Andrews, UK (November 2021). [[slides]]({{site.url}}/files/slides/CCS2021_V2.4_splitted.pdf)
- _Graph topology and habitat assortativity drive phenotypic differentiation in an eco-evolutionary model_, speaker, Conference on Complex Systems, Lyon, France (October 2021). {{% staticref "slides/CCS2021_V2.4_splitted.pdf" %}}[slides]{{% /staticref %}}
- _Using graph-based metrics to assess the effect of landscape topography on diversification_, speaker, ECBC, Amsterdam, Netherlands (October 2021). {{% staticref "slides/ECBC_amsterdam_v3.pdf" %}}[slides]{{% /staticref %}}
- _Solving non-local nonlinear Partial Differential Equations in high dimensions with_ `HighDimPDE.jl`, speaker, International Conference on Computational Methods in Systems Biology, Bordeaux, France (October 2021). {{% staticref "posters/poster_CMSB2021_Boussange.pdf" %}}[poster]{{% /staticref %}}
- _Responses of neutral and adaptive diversity to complex geographic population structure_, speaker, Mathematical Population Dynamics, Ecology and Evolution, CIRM Marseille, France (April 2021). {{% staticref "posters/CMPDEE21_VBOUSSANGE.pdf" %}}[poster]{{% /staticref %}}
